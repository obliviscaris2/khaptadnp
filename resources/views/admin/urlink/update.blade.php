...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form id="quickForm" method="POST" action="{{ route('urlink.update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $urlink->id }}">
                ...
                <div class="form-group">
                    ...
                    <input style="width:auto; color:white;" type="text" name="title" class="form-control" id="title"
                        placeholder="Title" value="{{ $urlink->title }}">
                </div>
               
                <div class="form-group">
                    <label for="Url">Url</label><span style="color:red; font-size:large"> *</span>
                    <input style="width:auto; color:white;" type="text" name="url" class="form-control" id="url"
                        placeholder="Url" value="{{ $urlink->url }}">
                </div>
